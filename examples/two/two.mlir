module {
  ...
  hw.module @Mux4(in %clock : !seq.clock, in %reset : i1, in %io_in0 : i1, in %io_in1 : i1, in %io_in2 : i1, in %io_in3 : i1, in %io_sel : i2, out io_out1 : i1, out io_out2 : i2) {
    ...
    hw.output %m2.io_out, %i1.io_out : i1, i2
  }
